          ...
          <table id="example1" class="table">
            ...
            <tbody>
              @foreach ($data as $murid)
                <tr>
                  ...
                  <td class="text-center">
                    <a class="btn btn-sm btn-success" href="#" data-toggle="modal"
                      data-target="#edit-{{ $murid->nisn }}"><i class="fa fa-user-edit"></i> update</a>
                    <a class="btn btn-sm btn-danger" href="#" data-toggle="modal"
                      data-target="#delete-{{ $murid->nisn }}"><i class="fa fa-trash-alt"></i> delete</a>
                  </td>
                </tr>

                {{-- Edit Modal --}}
                <div id="edit-{{ $murid->nisn }}" class="modal animated rubberBand delete-modal" role="dialog">
                            ...
                            <div class="row">
                              <div class="col-md-12">
                                <div class="card-header">
                                  <h5><img src="/asset/img/profile.png" width="40"> {{ $murid->nama }}</h5>
                                </div>
                                <div class="row">
                                  <div class="col-md-3">
                                    <div class="form-group">
                                      <label class="float-left">NISN</label>
                                      <input type="text" class="form-control" name="nisn"
                                        value="{{ $murid->nisn }}" placeholder="NISN">
                                    </div>
                                  </div>
                                  <div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" name="nama"
                                        value="{{ $murid->nama }}" placeholder="Nama">
                                    </div>
                                  </div>
                                  <div class="col-md-3">
                                    <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" name="umur"
                                        value="{{ $murid->umur }}" placeholder="Umur">
                                    </div>
                                  </div>
                                  <div class="col-md-3">
                                    <div class="form-group">
                                      <label class="float-left">Tahun Sekolah</label>
                                      <input type="text" class="form-control" name="tahun_sekolah"
                                        value="{{ $murid->tahun_sekolah }}" placeholder="Tahun Sekolah">
                                    </div>
                                  </div>
                                  <div class="col-md-3">
                                    <div class="form-group">
                                  ...
                                  <div class="col-md-3">
                                    <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" name="kontak"
                                        value="{{ $murid->kontak }}" placeholder="Kontak">
                                    </div>
                                  </div>
                                  <div class="col-md-3">
                                    <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" name="email"
                                        value="{{ $murid->email }}" placeholder="Email">
                                    </div>
                                  </div>
                                  <div class="col-md-12">
                                    <div class="form-group">
                                      <label class="float-left">Alamat</label>
                                      <textarea class="form-control" name="alamat">{{ $murid->alamat }}</textarea>
                                    </div>
                                  </div>
                                  <div class="col-md-12">
                                    <div class="form-group">
                ...
                {{-- Delete Modal --}}
                <div id="delete-{{ $murid->nisn }}" class="modal animated rubberBand delete-modal" role="dialog">
                    ...
                    <div class="modal-content">
                      <div class="modal-body text-center">
                        ...
                        <div class="m-t-20">
                          ...
                          <a href="/student/delete/{{ $murid->nisn }}" class="btn btn-danger">Delete</a>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <form action="/student/add" method="POST">
            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="card-header">
                    <h5><img src="/asset/img/profile.png" width="40">Menambahkan Murid Baru</h5>
                  </div>
                  <div class="row">
                    <div class="col-md-3">
                      <div class="form-group">
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        <label class="float-left">Tahun Sekolah</label>
                        <input type="text" class="form-control" name="tahun_sekolah" placeholder="Tahun Sekolah">
                      </div>
                    </div>
                    <div class="col-md-3">
                      <div class="form-group">
