...
@section('content')
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0"><img src="../asset/img/score.png" width="40"> Lihat Nilai</h1>
        </div>
        <div class="col-sm-6">
            ...
            <tbody>
              @foreach ($data as $d)
                ...
                <tr>
                  ...
                  <td>{{ $d['nilai']['subject'] }}</td>
                  <td>{{ $d['nilai']['deskripsi_tugas'] }}</td>
                  <td>{{ $d['nilai']['nilai'] }}</td>
                                  ...
                                  <div class="col-md-12">
                                    <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" name="subject"
                                        value="{{ $d['nilai']['subject'] }}" placeholder="Subject">
                                    </div>
                                  </div>
                                  <div class="col-md-12">
                                    <div class="form-group">
                                      <label class="float-left">Deskripsi Tugas</label>
                                      <input type="text" class="form-control" name="deskripsi_tugas"
                                        value="{{ $d['nilai']['deskripsi_tugas'] }}" placeholder="Deskripsi Tugas">
                                    </div>
                                  </div>
                                  <div class="col-md-12">
                                    <div class="form-group">
                                      <label class="float-left">Nilai</label>
                                      <input type="text" class="form-control" name="nilai"
                                        value="{{ $d['nilai']['nilai'] }}" placeholder="Nilai">
                                    </div>
                                  </div>
                                </div>
                              </div>
                    ...
                    <div class="modal-content">
                      <div class="modal-body text-center">
                        ...
                        <div class="m-t-20">
                          ...
                          <a href="/score/delete/{{ $nisn }}" class="btn btn-danger">Delete</a>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <form action="/score/add" method="POST">
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-md-12">
                  <div class="card-header">
                    <h5><img src="../asset/img/score.png" width="40">Menambah Nilai Baru</h5>
                  </div>
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
